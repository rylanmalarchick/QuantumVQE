...
\begin{itemize}
\item Use MPI for distributed computing across cluster nodes
\item Each process computes subset of bond lengths via scatter-gather
\item Expected speedup: Linear up to $p = 100$ processes (one per bond length)
\end{itemize}
