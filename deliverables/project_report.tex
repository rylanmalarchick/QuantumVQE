...
\begin{enumerate}
    ...
    \item \textbf{Memory Limits}: Single H100 (80GB) maxes out at 29 qubits. The state vector at 29 qubits is 8GB, but adjoint differentiation requires $\sim$4× memory overhead, totaling $\sim$32GB. At 30 qubits, the 64GB requirement exceeds available memory.
